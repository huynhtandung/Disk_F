<?php 
    ...
    if($router->getPOST("submit")){
        ...
        $sql = "insert into room(room_name,room_address, owner_username, room_price, room_description, room_lat, room_lan) values('$name','$address' ,'$owner_username', '$price', '$desc', '$lat', '$lan')";
        $db->insert($sql);
        $router->list();
    }
?>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <ol class="breadcrumb">
                <li>
                    <span class="glyphicon glyphicon-user"></span> &nbsp;ADD LODGING HOUSE
                </li>
            </ol>
            <hr />
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">       
                <form action="<?=$router->createUrl('public/lodgingHouse/addLodgingHouse')?>" method="POST" class="form-horizontal" role="form">
                        <div class="form-group">
                            <legend>Add loding house</legend>
                        </div>
                        <input type="text" name="name"class="form-control"required="required" placeholder="Nhap vao ten nha tro">
                        <br />
                        <input id='autocomplete' type="text" name="position"class="form-control"required="required" placeholder="Nhap vao vi tri">
                        <br/>                  
                        <input type="text" name="price"class="form-control"required="required" placeholder="Nhap vao gia tien">         
                        <br/>
                        <textarea placeholder="Nhap vao mo ta chi tiet" name="description"class="form-control" rows="3" required="required"></textarea>         
                        <br />
